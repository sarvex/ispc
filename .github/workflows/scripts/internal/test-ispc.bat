...
python run_tests.py -u FP -a xe64 -t %TESTS_TARGET% --l0loader=%GITHUB_WORKSPACE%\level-zero --ispc_output=%ISPC_OUTPUT% --fail_db=%FAIL_DB_PATH% --test_time 20 %EXTRA_ARGS% || goto :error
